...
if authenticated():
    ...
    if classifier == 'Support Vector Machine (SVM)':
        ...
        metrics = st.sidebar.multiselect("What metrices to plot?",
...
# ## About
# ---
# This is a landing page designed to showcase the login scenario of the web application.
#
# The goal is to create an web application and host it in the cloud platform and be able to make changes in the application.
#
